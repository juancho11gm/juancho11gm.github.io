...
const books: BookType[] = [
  {
    ...
    date: '2018',
    description:
      'Good habits can improve our lives. James provides ideas based on scientific research to transform our habits. They allow us to shape our behavior and how to apply the changes to our systems to improve our lives. ',
  ...
  },
  {
    ...
    date: '2020',
    description:
      'Doing well with money isn’t necessarily about what you know. It’s about how you behave. And behavior is hard to teach, even to really smart people. 19 short stories exploring the strange ways people think about money and teaches you how to make better sense of one of life’s most important topics.',
  ...
  },
  {
    ...
    date: '2016',
    description:
      'Understand the emotional intelligence to achieve the best agreements. Learn from experiences shared by an FBI kidnapper negotiator. These lessons work for business and personal life.',
  ...
  },
  {
    ...
    date: '2019',
    description:
      'Tips to financial success through stories. Stories about borrowing, saving, investing and spending.',
    tags: ['🪴 Personal Growth', '🐷 Finance'],
    imageUrl: '/assets/books/lo-que-debes-saber-del-dinero.webp',
    shopUrl:
      'https://www.planetadelibros.com.co/libro-lo-que-debes-saber-del-dinero-y-nunca-te-ensenaron-nueva-edicion/352267',
  },
  {
    ...
    date: 'Original 1926',
    description:
      'Learn financial principles through novel stories in the ancient Babylon.',
    tags: ['🪴 Personal Growth', '🐷 Finance'],
  ...
  },
  {
    ...
    imageUrl: '/assets/books/invent-and-wander.jpg',
